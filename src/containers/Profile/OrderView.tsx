                ...
                <Col span={17} className='left-side-order-view'>
                    ...
                    {order?.design && (
                        <Row>
                            ...
                            {order?.type_content === '2' && (
                                <div className='d-flex'>
                                    ...
                                    <div className='text'>
                                        ...
                                        авторском контенте для каналов - Читать инструкцию
                                    </div>
                                </div>
                            )}
                            <div>
                                <a target='_blank' rel='noreferrer' href={order?.design?.url}>
                            ...
                            <div>
                                <Switch className='mr-13' onChange={(e) => () => changeSwitch(e, 1)}/>
                                Я поменял название и оформление канала (доп: загрузил авторский контент)
                            </div>
                    ...
                    <Row>
                        <Col span={24}>
                            <div className='step-text'>
                                ...
                                Этап {order?.design ? '2' : '1'} | Передача
                                прав владельца
                            </div>
                            <div className='d-flex align-center text'>
                                ...
                                <div>
                                    <a href='https://vk.com/@dg.work-sozdanie-akkaunta-brenda'
                                        target='_blank' rel='noreferrer' className='text_underline'>
                            ...
                            <Row className='row-order-moderate'>
                                <Col span={6} className='content-right'>
                                    {order?.design ? (
                                        <Button
                                            className={`order-view-btn ${getButtonClass()}`} disabled={allow}
                                        ...
                                        <Button
                                            ...
                                            disabled={!secondSwitch} onClick={() => onConfirmClick()}
                                        >
                                            Отправить на модерацию
                                        </Button>
                                    )}
                        ...
                        <Row className='justify-content-between'>
                            ...
                            <Col span={19}>
                                ...
                                <div className='type-content'>
                                    ...
                                    <div className='value-text'>
                                        {order?.type_content === '2' ? 'авторский' : 'шортс'}
                                    </div>
                                </div>
                            </Col>
                        </Row>
                        ...
                        <Row className='align-center justify-content-between'>
                            ...
                            <Col span={19} className='align-center'>
                                <div className='timer-text'>
                                    <Statistic.Countdown title='Времени на выполнение' value={order?.time_expired}
                                        onFinish={onExpired}/>
                                </div>
                            </Col>
                        </Row>
